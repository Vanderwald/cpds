...
var Avatar = /** @class */ (function () {
    ...
    Object.defineProperty(Avatar, "style", {
        get: function () { return ".sc-ion-avatar-ios-h{border-radius:var(--border-radius);display:block;--border-radius:50%;width:48px;height:48px}.sc-ion-avatar-ios-s > img, .sc-ion-avatar-ios-s > ion-img{border-radius:var(--border-radius);width:100%;height:100%;-o-object-fit:cover;object-fit:cover;overflow:hidden}"; },
        enumerable: true,
        configurable: true
    });
...
var Badge = /** @class */ (function () {
    ...
    Object.defineProperty(Badge, "style", {
        get: function () { return ".sc-ion-badge-ios-h{--background:var(--ion-color-primary, #3880ff);--color:var(--ion-color-primary-contrast, #fff);--padding-top:3px;--padding-end:8px;--padding-bottom:3px;--padding-start:8px;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;padding:var(--padding-top) var(--padding-end) var(--padding-bottom) var(--padding-start);display:inline-block;min-width:10px;background:var(--background);color:var(--color);font-family:var(--ion-font-family,inherit);font-size:13px;font-weight:700;line-height:1;text-align:center;white-space:nowrap;contain:content;vertical-align:baseline;border-radius:10px}.ion-color.sc-ion-badge-ios-h{background:var(--ion-color-base);color:var(--ion-color-contrast)}.sc-ion-badge-ios-h:empty{display:none}"; },
        enumerable: true,
        configurable: true
    });
